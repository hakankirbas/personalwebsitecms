...
export interface ApiHeroBannerHeroBanner extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    cta: Schema.Attribute.Component<'ui-elements.cta', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
    title_colored: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiProjectTechnologyProjectTechnology
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::project-technology.project-technology'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    project_features: Schema.Attribute.Relation<
      ...
      'api::project-feature.project-feature'
    >;
    project_technologies: Schema.Attribute.Relation<
      'manyToMany',
      'api::project-technology.project-technology'
    >;
...
export interface ApiSkillTechnologySkillTechnology
  extends Struct.CollectionTypeSchema {
  collectionName: 'skill_technologies';
  info: {
    displayName: 'Skill Technology';
    pluralName: 'skill-technologies';
    singularName: 'skill-technology';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiSkillSkill extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    proficiency: Schema.Attribute.Enumeration<
      ['Expert', 'Advanced', 'Proficient', 'Intermediate', 'Beginner']
    >;
    publishedAt: Schema.Attribute.DateTime;
    skill_category: Schema.Attribute.Relation<
      ...
      'api::skill-categorie.skill-categorie'
    >;
    skill_technologies: Schema.Attribute.Relation<
      'oneToMany',
      'api::skill-technology.skill-technology'
    >;
    slug: Schema.Attribute.UID<'name'>;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::project-technology.project-technology': ApiProjectTechnologyProjectTechnology;
      'api::project.project': ApiProjectProject;
      'api::skill-categorie.skill-categorie': ApiSkillCategorieSkillCategorie;
      'api::skill-technology.skill-technology': ApiSkillTechnologySkillTechnology;
